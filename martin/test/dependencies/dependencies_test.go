    ...
    "button":[
        {
            "type":"view",
            "name":"使用介绍",
            "url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx33cc6387acefe650&redirect_uri=http%3A%2F%2F82.156.35.184%3A8080%2Fintroduce&response_type=code&scope=snsapi_base&state=1#wechat_redirect"
        },
        {
            "type":"view",
            "name":"体检商城",
